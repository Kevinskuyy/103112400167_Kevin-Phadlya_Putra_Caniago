...
Program ini digunakan untuk mengelola data makanan menggunakan struktur data Doubly Linked List, di mana setiap data bisa ditambah, ditampilkan, dan diubah (update) dari berbagai posisi dalam list.
...
Program ini menerapkan struktur data Doubly Linked List untuk menyimpan dan mengelola data kendaraan (nomor polisi, warna, tahun pembuatan).
...
Menambah data kendaraan (insert last)
Mengecek apakah nomor polisi sudah terdaftar
